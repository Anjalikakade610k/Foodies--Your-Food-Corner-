...
const RestaurantCard = (props) => {
    ...
    return(
        <div className = "leading-relaxed w-[18vw] h-[42vh] bg-[#edf5f9] m-4 rounded-xl p-1 shadow-lg border-2 shadow-gray-500 transition-transform duration-100 ease-in-out hover:cursor-pointer hover:scale-90 text-black overflow-hidden" >
            ...
            <div className="absolute bottom-0 rounded-xl left-0 right-0 h-1/3   bg-gradient-to-t from-black to-transparent "><span className="pl-2 text-start font-serif font-extrabold  text-[#edf5f4]  text-sm">{aggregatedDiscountInfoV3 ? aggregatedDiscountInfoV3.header + (" ") + aggregatedDiscountInfoV3.subHeader : ""}</span></div>
            </div>
