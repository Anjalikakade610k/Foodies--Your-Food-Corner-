    ...
    <div className="flex p-3 justify-between bg-customGreen shadow-lg m-2  max-h-[100%]">
      ...
      <div className="flex  my-auto">
        <ul className="flex">
          ...
          <Link to="/cart">
            {" "}
            <div className="  inline-flex  p-2 text-small m-2 font-serif hover:bg-teal-700  cursor-pointer  hover:text-customGreen  rounded">
          ...
          <div>
            ...
            <Link to="/login">
              {" "}
              <button
                className="text-xs px-2 py-1  hover:bg-teal-700  bg-gray-700 text-white inline-flex items-center justify-center rounded min-w-[60px]"
                onClick={() => {
                  btnName === "Log In"
                    ? setBtnName("Log Out")
                    : setBtnName("Log In");
